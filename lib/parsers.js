...
////////////////////* SurveillanceStation */////////////////////
module.exports.listEvents = (api, states, res) => {
    event.emit('debug', 'test - Response: ' + JSON.stringify(res));
...
module.exports.parseListSharings = (api, states, res) => {
    event.emit('debug', 'parseListSharings - Response: ' + JSON.stringify(res));
    let arr = res.links;
    let temp_array = [];
    arr.forEach((k, i) => {
        if (arr[i].id){
...
module.exports.parseCreateSharings = (states, res) => {
    event.emit('debug', 'parseCreateSharings - Response: ' + JSON.stringify(res));
    let arr = res.links;
